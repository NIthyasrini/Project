...
public class HomeDepot1 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement mouse2 = driver.findElement(By.xpath("//a[contains(text(),'Paint')]"));
		actions.moveToElement(mouse2).perform();
		
		
			
		WebElement mouse3 = driver.findElement(By.xpath("//a[text()='Interior Paint']]"));
		actions.moveToElement(mouse3).perform();
		
				
		WebElement button=driver.findElement(By.xpath("//a[contains(text(),'Ceiling Paint')]"));
		button.click();
